...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.plane.scale.x = (this.viewport.width * (1050 * this.scale)) / this.screen.width;
...
class App {
  ...
  addEventListeners() {
    ...
    // Bind interactive events directly to the container to restrict it to this section
    this.container?.addEventListener('mousewheel', this.boundOnWheel, { passive: false });
    this.container?.addEventListener('wheel', this.boundOnWheel, { passive: false });
    this.container?.addEventListener('mousedown', this.boundOnTouchDown);
    this.container?.addEventListener('touchstart', this.boundOnTouchDown, { passive: true });

    // Drag-over-window events are on window but only active after interaction starts inside the container
